...
namespace DelicatoProject.Aplicacao.Interfaces
{
    public interface ICardapioService
    {
        ...
        public Task<(bool Sucesso, string Mensagem)> AdicionarBebida(CardapioBebidaDTO bebida);
        public Task<(bool Sucesso, string Mensagem)> EditarBebida(CardapioBebidaDTO bebida);
        ...
        public Task<(bool Sucesso, string Mensagem)> AdicionarComida(CardapioComidaDTO comida);
        public Task<(bool Sucesso, string Mensagem)> EditarComida(CardapioComidaDTO novaComida);
